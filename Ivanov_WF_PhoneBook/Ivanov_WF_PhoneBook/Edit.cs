...
{
    public delegate void EditDelegate(string name, string phone, string address,
                                      string category, string description, string photo);

    public partial class Edit : Form
    {
        public event EditDelegate PerformEditContact;
        ...
        private void editButton_Click(object sender, EventArgs e)
        {
            ...
            {
                PerformEditContact?.Invoke(nameTextBox.Text, phoneTextBox.Text, addressTextBox.Text,
